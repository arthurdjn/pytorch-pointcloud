...
class MixDataset(Dataset, Randomizable):
    ...
    Args:
        ...
        seed: Seed for the partner index; `None` draws from the global generator (see `Randomizable`).
    """
    ...
    def __getitem__(self, index: int) -> Dict[str, Any]:
        ...
        other_index = int(torch.randint(len(self.dataset), (1,), generator=self.R).item())  # type: ignore[arg-type]
