...
class PVCNNSegmentation(SemanticSegmentationModel):
...
@register_model(
    ...
    weights=WeightsDict(
        url="hf://torch-pointcloud/pvcnn.s3dis-area5.mit-han-lab/resolve/a098f49f11480c59e19b14cebb8f40df11fdccdc/model.safetensors",
        dataset="s3dis-area5",
        metrics={"mIoU": 57.51, "OA": 86.58},
