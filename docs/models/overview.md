...
:pytorch-pointcloud-mini: `torch-pointcloud` ships 37 architectures across point cloud classification, semantic and instance segmentation, object detection, self-supervised pretraining, and generative modeling. Every model is registered with a timm-style factory:
