...
@pytest.mark.parametrize("dataset_cls", [ModelNet10, ModelNet40])
@pytest.mark.parametrize("train", [True, False])
def test_modelnet_dataset_raw_files_not_exist(dataset_cls: Type[_ModelNet], train: bool) -> None:
...
def test_modelnet_dataset_processed_files_exist(
    data_dir_factory: Callable[..., Path], dataset_cls: Type[_ModelNet], train: bool
) -> None:
...
@pytest.mark.parametrize("dataset_cls", [ModelNet10, ModelNet40])
@pytest.mark.parametrize("train", [True, False])
def test_modelnet_dataset_processed_files_not_exist(dataset_cls: Type[_ModelNet], train: bool) -> None:
...
@pytest.mark.parametrize("dataset_cls", [ModelNet10, ModelNet40])
def test_modelnet_dataset_pre_transform(data_dir_factory: Callable[..., Path], dataset_cls: Type[_ModelNet]) -> None:
...
@pytest.mark.parametrize("dataset_cls", [ModelNet10, ModelNet40])
def test_modelnet_dataset_pre_filter(data_dir_factory: Callable[..., Path], dataset_cls: Type[_ModelNet]) -> None:
...
@pytest.mark.parametrize("dataset_cls", [ModelNet10, ModelNet40])
def test_modelnet_dataset_transform(data_dir_factory: Callable[..., Path], dataset_cls: Type[_ModelNet]) -> None:
