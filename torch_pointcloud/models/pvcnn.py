...
from torch_pointcloud.ops import avg_voxelize, trilinear_devoxelize
...
class Voxelization(nn.Module):
    ...
    def forward(self, features, coords):
        ...
        return avg_voxelize(vox_coords.transpose(1, 2), features, self.r), norm_coords
...
class PVConv(nn.Module):
    ...
    def forward(self, inputs):
        ...
        voxel_features = trilinear_devoxelize(voxel_coords.transpose(1, 2), voxel_features, self.resolution)
