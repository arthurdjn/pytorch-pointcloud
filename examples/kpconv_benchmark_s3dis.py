...
NOTE: the reference protocol accumulates votes over repeated potential-sampled sphere crops at full
resolution; this single-pass whole-room eval lands 1-2 points below it.

Results vs reference (Area-5 mIoU):
