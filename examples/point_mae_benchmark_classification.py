...
MODELS: Dict[str, Dict[str, Any]] = {
    "point-mae-base.modelnet40.yatian-pang": {"dataset": "modelnet40"},
    "point-mae-base.modelnet40-8k.yatian-pang": {"dataset": "modelnet40"},
    "point-mae-base.scanobjectnn-objbg.yatian-pang": {"dataset": "scanobjectnn", "background": True, "variant": None},
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark the Point-MAE classifiers on ModelNet40 and ScanObjectNN.")
    parser.add_argument("--model", default="point-mae-base.modelnet40.yatian-pang", choices=sorted(MODELS))
