...
Usage:
    ...
    uv run --no-sync python examples/pointnet2_benchmark_s3dis_sw.py
    uv run --no-sync python examples/pointnet2_benchmark_s3dis_sw.py --limit 5
    uv run --no-sync python examples/pointnet2_benchmark_s3dis_sw.py --num-votes 3
"""
...
def main() -> None:
    ...
    print(
        f"yanx27 protocol: block={args.block_size} m, stride={args.stride} m, "
