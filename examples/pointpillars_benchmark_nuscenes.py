"""Evaluate `pointpillars-multihead.nuscenes.openpcdet` on nuScenes mini with 3D mAP.
...
def parse_args() -> Namespace:
    parser = ArgumentParser(description="PointPillars-MultiHead nuScenes 3D detection mAP benchmark.")
    parser.add_argument("--model", type=str, default="pointpillars-multihead.nuscenes.openpcdet")
