"""Evaluate `pointpillars-openpcdet-multihead.nuscenes` on nuScenes mini with 3D mAP.
...
def parse_args() -> Namespace:
    ...
    parser.add_argument("--model", type=str, default="pointpillars-openpcdet-multihead.nuscenes")
