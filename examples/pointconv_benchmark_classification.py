...
MODELS: Dict[str, Dict[str, Any]] = {
    "pointconv-density-base.modelnet40.wenxuan-wu": {"dataset": "modelnet40"},
}
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark the PointConv classifier on ModelNet40.")
