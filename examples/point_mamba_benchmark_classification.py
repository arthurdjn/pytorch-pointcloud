...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark the PointMamba classifiers on ModelNet40 and ScanObjectNN.")
    parser.add_argument("--model", default="point-mamba-base.modelnet40.dingkang-liang", choices=sorted(MODELS))
