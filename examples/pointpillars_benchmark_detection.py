...
Results:
    ...
    | pointpillars-multihead.nuscenes.openpcdet | mAP / NDS                   | 44.63 / 58.23                 | 44.34 / 57.08                 |
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark PointPillars 3D detection on KITTI or nuScenes.")
    parser.add_argument(
        "--model",
        default="pointpillars.kitti.openpcdet",
        choices=["pointpillars.kitti.openpcdet", "pointpillars-multihead.nuscenes.openpcdet"],
    )
