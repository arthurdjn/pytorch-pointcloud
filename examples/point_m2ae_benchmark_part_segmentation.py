"""Benchmark the Point-M2AE ShapeNetPart part-segmentation model (single pass, no voting).
...
Usage:
    uv run --no-sync python examples/point_m2ae_benchmark_part_segmentation.py
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark Point-M2AE part segmentation on ShapeNetPart.")
    parser.add_argument(
        "--model", default="point-m2ae-base.shapenetpart.renrui-zhang", help="Registered segmentation model name"
    )
