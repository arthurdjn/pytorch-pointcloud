...
MODELS: Dict[str, Dict[str, Any]] = {
    "point-m2ae-base.modelnet40.renrui-zhang": {"dataset": "modelnet40"},
    "point-m2ae-base.scanobjectnn-objbg.renrui-zhang": {"dataset": "scanobjectnn", "background": True, "variant": None},
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark the Point-M2AE classifiers on ModelNet40 and ScanObjectNN.")
    parser.add_argument("--model", default="point-m2ae-base.modelnet40.renrui-zhang", choices=sorted(MODELS))
