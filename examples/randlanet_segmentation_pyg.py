# type: ignore
# https://github.com/pyg-team/pytorch_geometric/blob/master/examples/randlanet_segmentation.py
...
def test(loader):
    ...
    for data in loader:
        ...
        for out, y, category in zip(outs.split(sizes), data.y.split(sizes), data.category.tolist()):
