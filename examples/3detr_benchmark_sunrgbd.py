...
| --------------- | ------------------------------ | ------------------------- |
| `3detr-fair.sunrgbd` | see run                        | 58.0 / 30.3               |
