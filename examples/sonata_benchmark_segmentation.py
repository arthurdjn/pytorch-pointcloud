"""Benchmark the Sonata linear-probe head on ScanNet with the indoor precise-evaluation protocol.
...
Usage:
    ...
    uv run --no-sync python examples/sonata_benchmark_segmentation.py --download
"""
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="Benchmark the Sonata linear-probe head on ScanNet with the indoor precise-evaluation protocol."
    )
