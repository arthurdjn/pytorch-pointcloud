...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Benchmark 3DETR 3D detection on SUN RGB-D or ScanNet.")
    parser.add_argument(
        "--model",
        default="3detr-m.scannet.fair",
        choices=["3detr.sunrgbd.fair", "3detr.scannet.fair", "3detr-m.scannet.fair"],
    )
