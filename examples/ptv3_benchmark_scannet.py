...
`legacy=True` (see `torch_pointcloud.models.point_transformer_v3`). Single-forward mIoU is a few points below
the published numbers, which use test-time augmentation.
